...
def main():
    ...
    parser.add_argument('--k', type=float, default=0.5, choices=(0.4, 0.5, 2), help='Pruning Ratio')
    ...
    if args.extra is not None:
        run_folder = osp.join(LOG_DIR, args.dataset +"_strat_" +args.strat +args.extra, name)
    else:
